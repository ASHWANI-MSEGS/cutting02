...
<div class="flex flex-col ">
    ...
    <div class="relative flex justify-center w-auto h-screen pb-4">


            <div class="flex flex-col mt-10 ml-20 lg:w-1/2 lx:w-1/3">
                ...
                <!-- 1.Top with success logo -->
                    ...
                    <div class="h-64 h-auto bg-white border-gray-200 rounded-t-lg rounded-b-lg">
