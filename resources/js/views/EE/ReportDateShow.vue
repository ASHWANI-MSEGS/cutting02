                ...
                <div  class="relative pb-2 pr-2 mx-10 mt-10 mb-3 border rounded-lg">
                    <label class="absolute px-4 py-2 font-bold text-blue-500 text-md">Assigned Engineer</label>
                                <select v-model="form1.engineer"  @input="updateLr()" class="w-full px-3 pt-6 mt-1 ml-1 bg-white rounded-lg text-textgrayform focus:outline-none"   :errors="errors">
                                    ...
                                    <option v-for="engineer in engineers" v-bind:value="engineer.id" class="inline-block ml-2 mr-2 text-textgrayform" :key="engineer.id">  {{engineer.name}}, {{engineer.post}}</option>
                                </select>
                </div>

                <div class="flex items-center justify-center pt-2 ">
                    <button class="px-4 py-2 text-sm font-bold text-white bg-green-500 rounded hover:bg-green-400" @click="approve">Verify & Assign</button>
                ...
                <div class="h-auto py-3 bg-white border-gray-200 rounded-t-lg rounded-b-lg sm:w-5/5 lg:w-1/2">
                    ...
                    <div class="flex justify-start py-2 pl-2 ml-0 md:ml-8">
                        ...
                        <div class="grid grid-cols-2 gap-1 mx-1 md:gap-2 md:mx-4 lg:ml-8">
                                ...
                                <p class="py-1">Road Cut ni tur</p>
