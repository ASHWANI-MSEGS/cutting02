<template>
<div class="flex flex-col h-screen  w-full md:w-4/5 lg:w-1/2">

    <div class="relative flex justify-center   pb-4">

        
            <div class=" mt-10 ml-20 flex flex-col w-full md:w-2/3 ">
                ...
                <!-- 1.Top with success logo -->
                    ...
                    <div class="flex items-center justify-center flex-col bg-white h-24 rounded-b-lg">
                        ...
                        <p class="font-sans font-thin text-sm">Payment is Successful</p>
                    ...
                    <div class="py-2 bg-white h-64 rounded-t-lg  h-auto rounded-b-lg border-gray-200">
