       ...
       <!-- Assign modals -->
        <div v-if="modalA" class="absolute bg-white left-0 top-2 right-0 rounded-lg  sm:h-48 md:h-64  sm:w-2/3 lg:w-2/4 xl:w-1/4  ml-auto mr-auto  shadow z-40">
            <form @submit.prevent="approve">
                ...
                <div class="text-textblueform  flex justify-center my-6  font-bold text-xl ">Grant Permission</div>

                
                    <label class="flex justify-center text-blue-500 px-4 py-2 text-md font-bold">Do you want to approve</label>
        ...
        <div class=" md:mt-6  flex  flex-col  w-full lg:w-3/5  ">
            <div v-if="loading">
                Loading...
            </div>

            <div v-else class="my-6 ">
                <div class="rounded-t-lg pt-1  flex items-center justify-center h-32 bg-successcyan">
                    <div class="">
                ...
                <div class="flex items-center justify-center flex-col bg-white h-auto rounded-b-lg py-2 px-2">
                    <p class="text-2xl font-normal">Permission Granted!!</p>
                    <p class="font-sans font-thin text-xl">Depth of cutting shall not be less than two (2) feet from road surface</p>
                    <p class="font-sans font-thin text-xl">Kawng Laih tur hi feet 2 aiin a thuk ngei ngei tur a ni</p>
                </div>
                ...
                <div class="bg-white h-auto rounded-t-lg   rounded-b-lg border-gray-200">
                    ...
                    <div class=" mx-8 py-8" style="page-break-before:always;">                       
                    ...
                    <div class=" mx-8 py-8" style="page-break-before:always;"> 
                        ...
                        <div class="mt-8 flex flex-col items-end">
                            <div>
                                ...
                                <template v-if="form.division_id === 1">
                                    <p>Road South Division</p>
                                </template>
                                <template v-if="form.division_id === 2">
                                    <p>Road North Division</p>
                                </template>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            axios.get('/api/auth/permissionShow/' + this.$route.params.id)
                .then(response => {
