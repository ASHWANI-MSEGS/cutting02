...
<div class="flex flex-col ">
    ...
    <div class="relative flex justify-center w-auto h-auto pb-4 bg-gray-200">


            <div class="flex flex-col w-4/5 mx-10 mt-10  md:w-2/4 lg:w-1/3">
                ...
                <!-- 1.Top with success logo -->
                    ...
                    <div class="flex flex-col items-center justify-center h-24 bg-white rounded-b-lg">
                        <p class="text-2xl font-normal">Road Cutting Completion Report!</p>
                        <p class="font-sans text-sm font-thin">Road Cutting i zawh report kan lo dawng e</p>
                    ...
                    <div class="flex flex-row items-center justify-between h-24 mt-3 bg-white border-b-4 border-dashed rounded-t-lg rounded-b-lg">
                            ...
                            <button class="mr-8 hover:text-gray-400" @click.prevent="printme">
                                <svg version="1.1" class="text-gray-700 fill-current" id="Layer_1" width="30" height="30" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    ...
                    <div class="h-auto bg-white border-gray-200 rounded-t-lg rounded-b-lg">
                        ...
                        <div class="flex justify-start py-2 pl-2 my-8 ml-8">
                            ...
                            <div class="flex flex-col ">
                                ...
                                <p class="py-1">Road cutting date:</p>
                                <p class="py-1">Completion Date:</p>
                                <p class="py-1">Reported On: </p>
                            </div>
...
export default {
    ...
    mounted(){
        axios.get('/api/auth/reportCompleteSuccess/'+this.$route.params.id)
        .then(response=>{
