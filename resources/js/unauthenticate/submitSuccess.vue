<template>
    <div class="flex flex-col ">
        ...
        <div class="relative flex justify-center w-auto h-auto pb-4">


            <div class="flex flex-col my-10 w-12/12 md:w-4/5 lg:w-3/5 xl:w-2/5">
                ...
                <!-- 2. -->
                <div id="specificPrint">
                    <div class="flex flex-col items-center justify-center h-24 bg-white rounded-b-lg">
                        <p class="text-2xl font-normal">Well Done!!</p>
                        <p class="text-xl font-normal">Hei hi i hmuh chuan <b>apply nawn lo</b> la</p>
                        <p class="font-sans text-sm font-thin">I Memo Number hi chhinchhiah tha ang che</p>
                    </div>
                    ...
                    <div class="h-auto bg-white border-gray-200 rounded-t-lg rounded-b-lg">
                        <div class="flex justify-center py-2 pl-2 my-8 ml:0 md:ml-8">
                            <div class="flex flex-col ">
                                <p class="py-1">Name</p>
                                ...
                                <br>
                                <p class="py-1">Khua/City/Town/Village</p>
                            ...
                            <div class="flex flex-col pb-3 ml-0 md:ml-4">
                                ...
                                <hr>
                                <p class="py-1">: </p>
                                <p class="py-1">: {{ form.rhouseno }},</p>
                                <p class="">{{ form.rlocalcouncil_name }}</p>
                                ...
                                <template v-if="form.water_id === 0">
                                    <p class="py-1">: Tui New Connection</p>
                                </template>
                                <template v-else-if="form.water_id === 1">
                                    <p class="py-1">: Tui Old Connection</p>
                                </template>
                                <template v-else>
                                ...
                                <template v-if="form.road_type === 0">
                                    <p class="py-1 text-md">: Flexible Pavement</p>
                                    <p class=" text-md">(Alkatra luan)</p>
                                </template>
                                <template v-else-if="form.road_type === 1">
                                    <p class="py-1 text-md">: Rigid Pavement</p>
                                    <p class=" text-md">(Concrete-a siam) </p>
                                </template>
                                <template v-else>
                                    <p class="py-1">: Others</p>
                                    <p class=""> (Thildang)</p>
                                </template>
                                <p class="py-1">: {{ form.length }}</p>
