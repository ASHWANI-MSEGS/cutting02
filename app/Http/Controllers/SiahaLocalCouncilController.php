...
class SiahaLocalCouncilController extends Controller
{
    /**
    ...
    public function index()
    {
        try {
            ...
            $localcouncils = SiahaLocalCouncil::all();
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request,[
            ...
            $localcouncil= new SiahaLocalCouncil();
     ...
     *
     * @param  \App\SiahaLocalCouncil  $siahaLocalCouncil
     * @return \Illuminate\Http\Response
     */
    public function show( $id)
    {
        $localcouncil = SiahaLocalCouncil::findOrFail($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(SiahaLocalCouncil $siahaLocalCouncil)
    {
    ...
    {
        $localcouncil=SiahaLocalCouncil::find($request->id);
        $localcouncil->name = $request->name;
        $localcouncil->division_id = $request->division_id;
        $localcouncil->sub_div = $request->sub_div;
        $localcouncil->save();
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(SiahaLocalCouncil $siahaLocalCouncil)
    {
        //
    }
