...
// module
exports.push([module.i, ".error[data-v-12f5395a] {\n  text-align: center;\n  color: red;\n}\n", ""]);
...
var render = function() {
  ...
  return _c("div", { staticClass: "h-screen" }, [
    _c(
      "div",
      { staticClass: "mx-auto h-full flex justify-center items-center " },
      [
        _c(
          "div",
          { staticClass: "w-96 pt-2 bg-blue-900 rounded-lg shadow-xl p-6" },
          [
            _c("h1", { staticClass: "text-white text-3xl pt-3" }, [
              _vm._v("PWD")
            ]),
            _vm._v(" "),
            _c("h1", { staticClass: "text-white text-3xl pt-6" }, [
              _vm._v("Login")
            ]),
            _vm._v(" "),
            _c("h2", { staticClass: "text-blue-300" }, [
              ...
              [
                _c("div", { staticClass: "relative" }, [
                  _c(
                    ...
                    {
                      staticClass:
                        "uppercase text-blue-500 text-xs font-bold absolute pl-3 pt-2",
                      attrs: { for: "email" }
                    },
                    [_vm._v("Email:")]
                  ),
                  ...
                  _c("div", [
                    _c("input", {
                      ...
                      staticClass:
                        "pt-8 w-full rounded p-3 bg-blue-800 text-gray-100 outline-none focus:bg-blue-700",
                      attrs: {
                        id: "email",
                        type: "email",
                ...
                _vm._v(" "),
                _c("div", { staticClass: "relative pt-3" }, [
                  _c(
                    "label",
                    {
                      staticClass:
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "flex justify-between pt-8 text-white text-sm font-bold"
                  },
                  [
                    _c(
                      "a",
                      {
                        staticClass: "hover:text-blue-200",
                        attrs: { href: "#" }
                      },
                      [
                        _vm._v(
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "pt-8" }, [
      _c("input", {
        staticClass:
          "w-full bg-gray-400 py-2 px-3 text-center uppercase rounded text-blue-800 font-bold",
